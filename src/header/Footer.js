...
export default function Footer() {
    ...
    return (
        <footer style={{
            backgroundColor: currentTheme.footer.backgroundColor,
            padding: '16px'
        }}>
            ...
            <p style={{color: currentTheme.footer.textColor}}>Developed by <a href={"https://www.linkedin.com/in/florencesytsang/"} style={{color: currentTheme.footer.textColor}}>Florence
                T.</a></p>
